...
contract Counter is BaseHook {
        ...
        returns (bytes4, BeforeSwapDelta, uint24)
    {
        ...
        beforeSwapCount[key.toId()] = current.add(FHE.asEuint128(1));
        ...
        returns (bytes4, int128)
    {
        ...
        afterSwapCount[key.toId()] = current.add(FHE.asEuint128(1));
    ...
    function _beforeAddLiquidity(
        ...
        beforeAddLiquidityCount[key.toId()] = current.add(FHE.asEuint128(1));

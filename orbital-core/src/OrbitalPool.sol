...
import "./interfaces/IOrbitalMintCallback.sol";
import "./interfaces/IOrbitalSwapCallback.sol";
import "./interfaces/IOrbitalFlashCallback.sol";
...
contract OrbitalPool {
    ...
    constructor() {
        (factory, tokens, tickSpacing, fee) = IOrbitalPoolDeployer(msg.sender).parameters();
    }
    ...
    function flash(
        ...
        IOrbitalFlashCallback(msg.sender).orbitalFlashCallback(data);
